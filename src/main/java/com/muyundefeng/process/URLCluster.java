...
public class URLCluster {
    ...
    public static final String urlFile = "/home/lisheng/桌面/output7/part-r-00000";//存放url的文件路径

    public static final String HOST_NAME = "sohu.com";//主机名，将部分主机名剔除掉

    public static final String URL_SAVE_PATH = "/home/lisheng/桌面/URL/";
